...
public class PIMSProcess_40_50 {
	...
	private Map<String, String> readValuesForSN(String dhctSN)
		...
		while (rSet.next()) {
			...
			mValues.put("STRGY", rSet1.getString("strategy"));
		}
		...
		rSet = pstmt.executeQuery();
		while (rSet.next()) {
			String tStr = PIMSHelper.convertByteToHexString(rSet.getBytes("pub_key_cert"));
